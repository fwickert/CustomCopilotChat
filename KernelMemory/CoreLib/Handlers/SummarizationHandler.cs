...
public class SummarizationHandler : IPipelineStepHandler
{
    ...
    private readonly string _summaizationPrompt;
        ...
        ILogger<SummarizationHandler>? log = null)
    {
        ...
        this._summaizationPrompt = promptProvider.ReadPrompt(Constants.PromptNamesSummarize);
    ...
    private async Task<(string summary, bool skip)> SummarizeAsync(string content)
    {
        ...
        while (!done)
        {
            ...
            for (int index = 0; index < paragraphs.Count; index++)
            {
                ...
                var filledPrompt = this._summaizationPrompt.Replace("{{$input}}", paragraph, StringComparison.OrdinalIgnoreCase);
